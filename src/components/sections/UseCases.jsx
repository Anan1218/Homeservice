...
export default function UseCases() {
  const benefits = [
    ...
    },
    {
      ...
      description: 'Deploy quickly with minimal training, without disrupting your business\'s daily operations.'
    },
    {
    ...
    <section className="py-20 bg-gray-50">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="text-center mb-16">
          <p className="text-sm text-gray-500 uppercase tracking-wide mb-2">Why Crewmate?</p>
          <h2 className="text-4xl lg:text-5xl font-serif mb-6">There's No Competition</h2>
          <p className="text-lg text-gray-600 max-w-4xl mx-auto">
            Built for businesses that refuse to settle, Crewmate's AI outperforms the rest—smarter, faster, and more reliable than any alternative.
          </p>
        </div>
